...
const Login = () => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
        ...
        if (staffId.includes('@')) {
            loginData = { email: staffId, password };
        } else if (staffId.includes('/')) {
            loginData = { staffId: staffId, password };
        } else {
            loginData = { username: staffId, password };
        }
  ...
  const onForgotContinue = async (e) => {
    e.preventDefault()
    setError('')
    setLoading(true)
    ...
    <div className="login-page">
      ...
      <div className="login-card" role="region" aria-label="Sign in">
        ...
        <form className="login-form" onSubmit={onSubmit}>
          ...
          <div className="login-hint">ie. CAS/186, AKS/UYO/09475</div>
          ...
          <AppButton className="login-submit" type="submit" disabled={!canSubmit || loading}>
            ...
            {!isForgotSuccessOpen ? (
              <>
                ...
                <form className="forgot-form" onSubmit={onForgotContinue}>
                  ...
                  <AppButton className="forgot-continue" type="submit" disabled={!canContinue || loading}>
